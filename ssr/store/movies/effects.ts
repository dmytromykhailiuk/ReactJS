...
export function* moviesSaga() {
  ...
  yield takeLatest(
    Action.setSortingOptionAction,
    Worker.setSortingOptionWorker
  );
  yield takeLatest(
    Action.setIsDownDirectionValueAction as any,
    Worker.loadMoviesWorker
  );
  yield takeLatest(
    Action.setSelectedCategoryAction,
    Worker.setSelectedCategoryWorker
  );
  yield takeLatest(
    Action.loadMovieInOverviewAction,
    Worker.loadMovieInOverviewWorker
  );
}
