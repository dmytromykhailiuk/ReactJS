...
const ModalWrapperContainer = (View: React.FC<ModalWrapperViewProps>): React.FC<ModalWrapperContainerProps> => ({
  header = null,
  onCloseModal,
  children,
}) => {
  ...
  return (
    <View modalWrapperRef={modalWrapperRef} errorMessages={errorMessages} header={header} onCloseModal={onCloseModal}>
      {children}
    </View>
  );
};
