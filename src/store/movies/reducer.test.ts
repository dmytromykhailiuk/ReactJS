...
describe('moviesReducer', () => {
  describe('default case', () => {
    it('should return same state', () => {
      expect(moviesReducer(moviesState, { type: UNEXPECTED_TYPE })).toEqual(moviesState);
    });
  });
  ...
  describe('loadMoviesSuccessAction', () => {
    it('should return state with new data', () => {
      ...
      expect(moviesReducer(moviesState, loadMoviesSuccessAction({ movies, totalAmount }))).toEqual({
        ...moviesState,
        loaded: true,
        moviesLoading: false,
        movies,
  ...
  describe('editMovieSuccessAction', () => {
    it('should return state with new data', () => {
      ...
      expect(moviesReducer(moviesState, editMovieSuccessAction(movie))).toEqual({
        ...moviesState,
        movieInOverview: moviesState.movieInOverview?.id === movie?.id ? movie : moviesState.movieInOverview,
        movies: [...moviesState.movies.map((currentMovie) => (movie.id === movie?.id ? movie : currentMovie))],
        selectedMovie: null,
      });
    });
    ...
    it('should return state with new data when were passed existing id', () => {
      ...
      expect(moviesReducer(state, editMovieSuccessAction(movie))).toEqual({
        ...state,
        movieInOverview: state.movieInOverview?.id === movie?.id ? movie : state.movieInOverview,
        movies: [...state.movies.map((currentMovie: any) => (movie.id === movie?.id ? movie : currentMovie))],
        selectedMovie: null,
      });
    });
  ...
  describe('deleteMovieSuccessAction', () => {
    ...
    it("should return state with new data when weren't passed existing id", () => {
      ...
      expect(moviesReducer(moviesState, deleteMovieSuccessAction(id))).toEqual({
        ...moviesState,
        movies: [...moviesState.movies.slice(0, index), ...moviesState.movies.slice(index + 1)],
        selectedMovie: null,
        moviesAmount: moviesState.moviesAmount - 1,
      });
    });
    ...
    it('should return state with new data when were passed existing id', () => {
      ...
      expect(moviesReducer(state, deleteMovieSuccessAction(id))).toEqual({
        ...state,
        movies: [...state.movies.slice(0, index), ...state.movies.slice(index + 1)],
        selectedMovie: null,
  ...
  describe('setSelectedCategoryAction', () => {
    it('should return state with new data', () => {
      expect(moviesReducer(moviesState, setSelectedCategoryAction(null))).toEqual({
        ...moviesState,
        moviesLoading: true,
      });
    });
  ...
  describe('setSelectedCategorySuccessAction', () => {
    it('should return state with new data', () => {
      ...
      expect(moviesReducer(moviesState, setSelectedCategorySuccessAction(selectedCategory))).toEqual({
        ...moviesState,
        selectedCategory,
      });
    });
  ...
  describe('setSortingOptionSuccessAction', () => {
    it('should return state with new data', () => {
      ...
      expect(moviesReducer(moviesState, setSortingOptionSuccessAction(sortingOption))).toEqual({
        ...moviesState,
        sortingOption,
      });
    });
  ...
  describe('setIsDownDirectionValueAction', () => {
    it('should return state with new data', () => {
      ...
      expect(moviesReducer(moviesState, setIsDownDirectionValueAction(isDownDirection))).toEqual({
        ...moviesState,
        isDownDirection,
        moviesLoading: true,
      });
  ...
  describe('loadMoreMoviesSeccessAction', () => {
    it('should return state with new data', () => {
      const arr = [] as any[];
      expect(moviesReducer(moviesState, loadMoreMoviesSeccessAction(arr))).toEqual({
        ...moviesState,
        moreMoviesLoaded: true,
  ...
  describe('loadMovieInOverviewAction', () => {
    it('should return state with new data', () => {
      expect(moviesReducer(moviesState, loadMovieInOverviewAction('string'))).toEqual({
        ...moviesState,
  ...
  describe('loadMovieInOverviewSuccessAction', () => {
    it('should return state with new data', () => {
      ...
      expect(moviesReducer(moviesState, loadMovieInOverviewSuccessAction(movieInOverview))).toEqual({
        ...moviesState,
        movieInOverview,
        movieInOverviewLoaded: true,
      });
  ...
  describe('loadMovieInOverviewFaildAction', () => {
    it('should return state with new data', () => {
      expect(moviesReducer(moviesState, loadMovieInOverviewFaildAction())).toEqual({
        ...moviesState,
        movieInOverviewLoaded: false,
      });
    });
