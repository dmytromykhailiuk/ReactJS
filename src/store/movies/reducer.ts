...
const moviesReducer = createReducer<MoviesState>(moviesInitialState, (builder) =>
  builder
    .addCase(loadMoviesSuccessAction, (state, { payload: { movies, totalAmount } }) => ({
      ...state,
      loaded: true,
      moviesLoading: false,
      movies,
    ...
    .addCase(editMovieSuccessAction, (state, { payload: editedMovie }) => ({
      ...state,
      movieInOverview: state.movieInOverview?.id === editedMovie.id ? editedMovie : state.movieInOverview,
      movies: [...state.movies.map((movie) => (movie.id === editedMovie.id ? editedMovie : movie))],
      selectedMovie: null,
    }))
    ...
    .addCase(setSelectedCategorySuccessAction, (state, { payload: selectedCategory }) => ({
      ...state,
      selectedCategory,
    }))
    ...
    .addCase(setSortingOptionSuccessAction, (state, { payload: sortingOption }) => ({
      ...state,
      sortingOption,
    }))
    .addCase(setIsDownDirectionValueAction, (state, { payload: isDownDirection }) => ({
      ...state,
      isDownDirection,
      moviesLoading: true,
    }))
    ...
    .addCase(ModalsAction.setModalInViewAction, (state, { payload: { selectedMovie = null } }) => ({
      ...state,
      selectedMovie,
    }))
    ...
    .addCase(loadMovieInOverviewSuccessAction, (state, { payload: movieInOverview }) => ({
      ...state,
      movieInOverview,
