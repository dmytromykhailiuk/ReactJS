...
const CheckboxIcon: React.FC<CheckboxIconProps> = ({ isLarge = false }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width={isLarge ? "30px" : "12px"} height={isLarge ? "30px" : "12px"} viewBox="0 0 1280.000000 1253.000000" preserveAspectRatio="xMidYMid meet">
