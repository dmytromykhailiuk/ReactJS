    ...
    {(formik) => {
      ...
      return (
        <form onSubmit={formik.handleSubmit}>
          {movie.id && (
            <Input disabled name={MovieFormValues.MOVIE_ID} type="text" label="MOVIE ID" value={String(movie.id)} />
          )}
          ...
          <Input
            ...
            label="RELEASE DATE"
            error={
              formik.errors[MovieFormValues.RELEASE_DATE] && formik.touched[MovieFormValues.RELEASE_DATE]
                ? formik.errors[MovieFormValues.RELEASE_DATE]
                : ''
            }
          ...
          <Input
            ...
            label="MOVIE URL"
            error={
              formik.errors[MovieFormValues.MOVIE_URL] && formik.touched[MovieFormValues.MOVIE_URL]
                ? formik.errors[MovieFormValues.MOVIE_URL]
                : ''
            }
          ...
          <Dropdown
            ...
            options={categories}
            error={
              formik.errors[MovieFormValues.CATEGORY] && formik.touched[MovieFormValues.CATEGORY]
                ? formik.errors[MovieFormValues.CATEGORY]
                : ''
            }
          />
          ...
          <Input
            ...
            label="OVERVIEW"
            error={
              formik.errors[MovieFormValues.OVERVIEW] && formik.touched[MovieFormValues.OVERVIEW]
                ? formik.errors[MovieFormValues.OVERVIEW]
                : ''
            }
          ...
          <Input
            ...
            label="RATING"
            error={
              formik.errors[MovieFormValues.RATING] && formik.touched[MovieFormValues.RATING]
                ? formik.errors[MovieFormValues.RATING]
                : ''
            }
          ...
          <Input
            ...
            label="RUNTIME"
            error={
              formik.errors[MovieFormValues.RUNTIME] && formik.touched[MovieFormValues.RUNTIME]
                ? formik.errors[MovieFormValues.RUNTIME]
                : ''
            }
          ...
          <div className={classes.buttons}>
            <Button type={ButtonTypes.SECONDARY} onButtonClicked={() => formik.resetForm()}>
              RESET
            </Button>
            <Button isSubmit type={ButtonTypes.PRIMARY} disabled={!formik.isValid || !formik.dirty}>
              {submitButtonLabel}
            </Button>
          </div>
        </form>
